# **COA2024-programming01**

## 0.前言

​	编程作业使用**seecoder**平台（和软工一使用相同平台），选课码**COA2024**，加入课程后以相同的操作clone代码到本地，写完后push到作业仓库。

​    注：clone后如果idea不能正确执行test，请按照以下步骤操作：
​	1.右键src/main/java文件夹，Mark Directory as Sources Root；
​	2.右键src/test/java文件夹，Mark Directory as Test Sources Root；
​	3.如果test文件标红，鼠标移动至junit将其添加至classpath。

​	请注意：本次编程作业截止时间为2024-10-18 22:00

​	编程作业严禁抄袭！

​	有任何平台相关问题请联系编程助教解决。
​    助教邮箱：[502024320010@smail.nju.edu.cn](mailto:502024320010@smail.nju.edu.cn) [502024320001@smail.nju.edu.cn](mailto:502024320001@smail.nju.edu.cn)
​    Seecoder部署在学校提供的服务器上，容易出现断网断电问题，如有问题请及时联系助教。
