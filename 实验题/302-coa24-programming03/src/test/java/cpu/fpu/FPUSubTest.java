...
public class FPUSubTest {
    ...
    public void fpuSubTest9() {
        float pZero = Float.parseFloat(Transformer.binaryToFloat("00000000000000000000000000000000"));//0
        ...
        float NAN = Float.NaN;
        float deNorm1 = Float.parseFloat(Transformer.binaryToFloat("00000000000000000000000000000001"));//5
...
//                pZero, nZero,
//                pInf, nInf, NAN,
                deNorm1, deNorm2, deNorm3, small1, small2, big1, big2, 10000000, 1.2f, 1.1f, 1, 0.9f, 0.8f, 0.7f, 0.6f, 0.5f, 0.4f, 0.3f, 0.2f, 0.1f, -0.1f, -0.2f, -0.3f, -0.4f, -0.5f, -0.6f, -0.7f, -0.8f, -0.9f, -1, -10000000};
        ...
        for (int i = 0; i < input.length; i++) {
            for (int j = 0; j < input.length; j++) {
                ...
                result = fpu.sub(src, dest);
                util.Transformer.intToBinary(Integer.toString(Float.floatToIntBits(input[j] - input[i])));
