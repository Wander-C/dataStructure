...
public class FPUAddTest {
    ...
    public void fpuAddTest9() {
        ...
        float[] input = {
//                pZero, nZero, pInf, nInf, NAN, deNorm1, deNorm2, deNorm3, small1, small2,big1, big2,10000000,1.2f, 1.1f, 1,
        ...
        for (float opr1 : input) {
            for (float opr2 : input) {
                ...
                result = fpu.add(src, dest);
                DataType a=new DataType(Transformer.intToBinary(Integer.toString(Float.floatToIntBits(opr1+opr2))));
